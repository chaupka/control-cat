...
namespace TheKiwiCoder
{
    public class BehaviourTreeView : GraphView
    {
        ...
        public ScriptTemplate[] scriptFileAssets =
        {
            ...
            new ScriptTemplate
            {
                templateFile = BehaviourTreeSettings
                    .GetOrCreateSettings()
                    .scriptTemplateCompositeNode,
        ...
        public override void BuildContextualMenu(ContextualMenuPopulateEvent evt)
        {
            ...
            evt.menu.AppendAction(
                $"Create Script.../New Action Node",
                (a) => CreateNewScript(scriptFileAssets[0])
            );
            evt.menu.AppendAction(
                $"Create Script.../New Composite Node",
                (a) => CreateNewScript(scriptFileAssets[1])
            );
            evt.menu.AppendAction(
                $"Create Script.../New Decorator Node",
                (a) => CreateNewScript(scriptFileAssets[2])
            );
